...
@app.route(LAUNCH_ROUTER, methods=['GET'])
...
def app_launched():
    ...
    if ACCESS_TOKEN:
        ...
        return render_template('welcome.html', shop=shop, ACCESS_TOKEN=ACCESS_TOKEN)
...
@app.route(REDIRECT_ROUTER, methods=['GET'])
@helpers.verify_web_call
def app_installed():
...
@app.route(UNINSTALL_ROUTER, methods=['POST'])
